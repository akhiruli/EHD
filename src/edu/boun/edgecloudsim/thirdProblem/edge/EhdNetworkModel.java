...
public class EhdNetworkModel extends NetworkModel {
    ...
    public static final double[] experimentalWanDelay = {
            ...
            /*1 Client*/ 1703.973 /*(Kbps)*/,
            /*2 Clients*/ 1023.957 /*(Kbps)*/,
            /*3 Clients*/ 9887.785 /*(Kbps)*/,
            /*4 Clients*/ 8915.775 /*(Kbps)*/,
            /*5 Clients*/ 8259.277 /*(Kbps)*/,
            /*6 Clients*/ 7560.574 /*(Kbps)*/,
    ...
    public EhdNetworkModel(int _numberOfMobileDevices, String _simScenario) {
    ...
    public void initialize() {
        ...
        networkDataset = NetworkDataset.getInstance();
        networkDataset.loaddata();
...
//        }
    ...
    private double getWlanDownloadDelay(Location accessPointLocation, double dataSize) {
        int numOfWlanUser = Math.abs(wlanClients[accessPointLocation.getServingWlanId()]);
        double taskSizeInKb = dataSize * (double)8; //KB to Kb
        //double taskSizeInKb = dataSize; //KB to Kb
        double result=0;
        //double bw = networkDataset.getData(CloudSim.clock());
        if(numOfWlanUser>= 0 && numOfWlanUser < experimentalWlanDelay.length) {
            //result = taskSizeInKb /*Kb*/ / (experimentalWlanDelay[numOfWlanUser] * (double) 3) /*Kbps*/; //802.11ac is around 3 times faster than 802.11n
            result = taskSizeInKb /*Kb*/ / (experimentalWlanDelay[numOfWlanUser]) /*Kbps*/; //802.11ac is around 3 times faster than 802.11n
            //result = taskSizeInKb /*Kb*/ / bw;
            if(result == 0){
                result = 1;
            }
        }
    ...
    private double getWanDownloadDelay(Location accessPointLocation, double dataSize) {
        int numOfWanUser = Math.abs(wanClients[accessPointLocation.getServingWlanId()]);
        double taskSizeInKb = dataSize * (double)8; //KB to Kb
        //double taskSizeInKb = dataSize; //KB to Kb
        double result=0;
        //double bw = networkDataset.getData(CloudSim.clock());
        //System.out.println(networkDataset.getData(CloudSim.clock()) + " : "+experimentalWanDelay[numOfWanUser]/3);
//        Integer index = Math.toIntExact(Helper.getRandomInteger(0, experimentalWanDelay.length - 1));
//        result = taskSizeInKb /*Kb*/ / (experimentalWanDelay[numOfWanUser]) /*Kbps*/;
        if(numOfWanUser < experimentalWanDelay.length){
            result = taskSizeInKb /*Kb*/ / (experimentalWanDelay[numOfWanUser]/3) /*Kbps*/;
            //result = taskSizeInKb /*Kb*/ / (bw) /*Kbps*/;
            if(result == 0){
                result = 1;
            }
        }
        ...
        if(result == 0){
            SimLogger.printLine("Delay 0: numOfWlanUser: "+numOfWanUser+" experimentalWanDelay.length: "+experimentalWanDelay.length+" size: "+dataSize);
        }
