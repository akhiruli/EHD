...
public class SimSettings {
	...
	private double wifi_access_point_transmission_nanojoules_per_bit;
	private double wifi_access_point_reception_nanojoules_per_bit;
	...
	public static double cellular_base_station_nanojoules_per_bit_up_link;
	public static double cellular_base_station_nanojoules_per_bit_down_link;
	public static int EPISODE_SIZE;
	...
	public boolean initialize(String propertiesFile, String edgeDevicesFile, String applicationsFile){
		...
		try {
			...
			WIFI_DEVICE_TRANSMISSION_WATTHOUR_PER_BIT = Double.parseDouble(prop.getProperty("wifi_device_transmission_nanojoules_per_bit"));
			WIFI_DEVICE_RECEPTION_WATTHOUR_PER_BIT = Double.parseDouble(prop.getProperty("wifi_device_reception_nanojoules_per_bit"));
			wifi_access_point_transmission_nanojoules_per_bit = Double.parseDouble(prop.getProperty("wifi_access_point_transmission_nanojoules_per_bit"));
			wifi_access_point_reception_nanojoules_per_bit = Double.parseDouble(prop.getProperty("wifi_access_point_reception_nanojoules_per_bit"));

			CELLULAR_DEVICE_TRANSMISSION_WATTHOUR_PER_BIT = Double.parseDouble(prop.getProperty("cellular_device_transmission_nanojoules_per_bit"));
			CELLULAR_DEVICE_RECEPTION_WATTHOUR_PER_BIT = Double.parseDouble(prop.getProperty("cellular_device_reception_nanojoules_per_bit"));
			cellular_base_station_nanojoules_per_bit_up_link = Double.parseDouble(prop.getProperty("cellular_base_station_nanojoules_per_bit_up_link"));
			cellular_base_station_nanojoules_per_bit_down_link = Double.parseDouble(prop.getProperty("cellular_base_station_nanojoules_per_bit_down_link"));
			UPDATE_INTERVAL = Integer.parseInt(prop.getProperty("update_interval"));
			EPISODE_SIZE = Integer.parseInt(prop.getProperty("episode_size"));
	...
	private void parseApplicatinosXML(String filePath)
	{
		...
		try {	
			...
			SimLogger.printLine("Number of applications: "+ appList.getLength());
